...
from .tools import get_c_p_by_rev_d,calc_LnfPT_c,add_LnfPT,verif_LnfPT, cumul_qt_PT_by_LnfPT,sub_matrix, get_sum_qt_c_by_d,get_sum_qt_p_by_rev_d,get_sum_qt_p_by_d,get_p_c_by_d
from .CAW import CAW
import math
import numpy as np

def init_solution(data : Sub_data, dec : Dec):
    ...
    for i in ind_AVG:
        ...
        #print(indexes)
            ...
            CAW(sub_matrix(data.c,indexes),data.Q,QTs,indexes)

    
    cumul_qt_PT_by_LnfPT(dec.LnfPT[0])
